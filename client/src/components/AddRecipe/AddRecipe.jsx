...
const AddRecipe = () => {
    ...
    return (
        <div className="Add_recipe_wrapper">
            <div className="recipe_creator">
                <Link to='/home'><button className="btn_Add_recipe">Back</button></Link>
                ...
                {errors.hasOwnProperty('title') || errors.hasOwnProperty('summary') || errors.hasOwnProperty('spoonacularScore') || errors.hasOwnProperty('healthScore') ?  <p className="form_warning_msg">Enter all information to continue</p> : <button className="btn_cr_submit" type='submit'>Add New Recipe</button>}
                </form>
